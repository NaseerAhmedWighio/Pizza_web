        ...
        <footer className="bg-neutral-900 text-white py-12 px-6">
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div>
              ...
              <p className="text-neutral-400 text-sm">Block-B, North Nazimabad Town</p>
              <p className="text-neutral-400 text-sm">Karachi, Pakistan</p>
              <p className="text-neutral-200 text-sm mt-4 font-mono">+92 306 0022771</p>
              <p className="text-neutral-200 text-sm font-mono">+92 333 1399804</p>
            </div>
            <div>
              ...
              <p className="text-3xl font-black text-white">3 PM – 3 AM</p>
            </div>
          </div>
          <div className="max-w-7xl mx-auto border-t border-neutral-800 mt-12 pt-8 text-center text-neutral-500 text-[10px] uppercase tracking-[0.2em] font-medium">
            © {new Date().getFullYear()} De Pizza Town. All rights reserved.
          </div>
        </footer>
      </div>
    </Router>
